...
class code_with_harry
{
   ...
   virtual void display(){
    cout<<"mere bachoho.....maine tumse kaha tha "<<endl
    <<"ki ranbhumi me khelne se pahle , manobhumi me khela jata hai"<<endl;
   }// if we add virtual then only member function is called 
